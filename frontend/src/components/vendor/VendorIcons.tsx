...
/**
 * Professional SVG Icons for Vendor Pages
 * Replaces emojis with consistent, scalable vector icons
 */
...
export const MessageIcon = ({ className = 'w-6 h-6', size }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} width={size} height={size}>
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
  </svg>
);

export const MailIcon = ({ className = 'w-6 h-6', size }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} width={size} height={size}>
...
export const HandshakeIcon = ({ className = 'w-6 h-6', size }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} width={size} height={size}>
    <path d="M17 12h-5v2h5v-2zM8 12H3v2h5v-2z" />
    <path d="M12 2l-5 5v6l5 5 5-5V7l-5-5z" />
  </svg>
);

export const CurrencyIcon = ({ className = 'w-6 h-6', size }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} width={size} height={size}>
...
export const FileIcon = ({ className = 'w-6 h-6', size }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className} width={size} height={size}>
